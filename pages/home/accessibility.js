...
export async function getStaticProps() {
    const res = await fetch(
        "https://syncrow.kodagu.today/api/accesibility?populate[0]=page1_cover.media&populate[1]=page3_cover.media"
    );
    ...
    return (
        <div className="overflow-x-hidden">
            ...
            <div className="flex items-center">
                ...
                <div className="-mt-14 ml-10 pt-3 bg-center bg-no-repeat" style={{backgroundImage:`url("/logoSmall.png")`, backgroundSize: '40px 40px'}}>
                <Lottie
            ...
            <div className="h-full middle:hidden block">
                ...
                <div className="flex-1 mt-32 mb-2 flex justify-center items-center w-full pt-2 bg-center bg-no-repeat"  style={{backgroundImage:`url("/logoSmall.png")`, backgroundSize: '30px 30px'}}>
                    <Lottie
                        options={accessibilityOptions}
            ...
            {/* page2 */}
            <div id="multimedia" className="tablet:px-20 px-8 flex middle:flex-row flex-col items-center bg-default text-white">
                ...
                />                </div>
                <div className="middle:text-left text-center middle:mb-0 mb-10">
                    ...
                    variants={{
                        visible: { opacity: 1, scale: 1 },
                        hidden: { opacity: 0, scale: 0 }
                    }}  ><span className='text-6xl desktop:text-8xl text-white font-thin'
            style={{ fontFamily: `${guthen}` }}>Multimedia</span></motion.h1>
                    <motion.p  initial="hidden"
                    whileInView="visible"
                    viewport={{ once: false }}
                    transition={{ duration: 0.4 }}
                    variants={{
                        visible: { opacity: 1, scale: 1 },
                        hidden: { opacity: 0, scale: 0 }
                    }}   className="mt-4 text-base tracking-wide middle:text-left middle:w-7/12 text-center">Smart multimedia control gives you the flexibility to control your TV, Xbox or music player wirelessly from your smartphone. Our smart home multimedia solutions also provided advanced features like multi-room playback, specialized scenes, wireless streaming and more.</motion.p>
                </div>
            </div>
            {/* page3 */}

            <div id="homeAccessibility" className="h-screen w-screen middle:flex items-center justify-end tablet:px-20 px-8 hidden" style={{background:'url(https://syncrow.s3.ap-south-1.amazonaws.com/shutterstock_767977975_250167e4d4.png)',backgroundRepeat:"no-repeat",backgroundPosition:"center",backgroundSize:"cover"}}>
            <div className="w-1/3">
                <motion.h1  initial="hidden"
                    whileInView="visible"
                    viewport={{ once: false }}
            ...
            style={{ fontFamily: `${guthen}` }}>Interactive</span></motion.h1>
                <motion.h1  initial="hidden"
                    whileInView="visible"
                    viewport={{ once: false }}
                    transition={{ duration: 0.4 }}
                    variants={{
                        visible: { opacity: 1, scale: 1 },
                        hidden: { opacity: 0, scale: 0 }
                    }}   className='font-semibold tracking-wide -mt-10 text-4xl'>Home</motion.h1>
                <motion.p  initial="hidden"
                    whileInView="visible"
                    viewport={{ once: false }}
                    transition={{ duration: 0.4 }}
                    variants={{
                        visible: { opacity: 1, scale: 1 },
                        hidden: { opacity: 0, scale: 0 }
                    }}   className="mt-6  font-[aftika-light] tracking-wide leading-7 text-basemiddle:text-left text-center">A single click is all it takes to control everything in your home. Use your smartphone, our central intelligent hub, or your voice to change your home into your personal zone of peace. From appliances to security, everything is at your beck and command with just a simple touch.</motion.p>
            </div>
        </div>
...
<div className="w-screen h-5/12">
    <img src="/interactive-mobile.png" width="100%" alt="" />
</div>
            <div className="w-full text-center -mt-16 tablet:px-20 px-8 middle:mb-0 mb-10">
                <h1><span className='text-7xl desktop:text-8xl text-default font-thin'
            style={{ fontFamily: `${guthen}` }}>Interactive</span></h1>
                <h1 className='font-semibold tracking-wide -mt-10 text-4xl'>Home</h1>
                <p className="mt-6  font-[aftika-light] tracking-wide leading-7 text-base middle:text-left text-center">A single click is all it takes to control everything in your home. Use your smartphone, our central intelligent hub, or your voice to change your home into your personal zone of peace. From appliances to security, everything is at your beck and command with just a simple touch.</p>
            </div>
        </div>
{/* medium responsive */}
