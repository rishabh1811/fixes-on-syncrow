    ...
    >
      ...
      <div className='md:flex items-start justify-between'>
        <div className='grid grid-cols-3 text-default text-xs gap-10'>
          ...
          <ul>
            ...
            <li className='my-2'>
              <Link href='/build' className='text-base'>
                Build Your Own
              </Link>
            </li>
          </ul>
          ...
          <ul>
            ...
            <li className='my-2'>
              <Link href='/workspace' className='text-base'>
                Workspace
              </Link>
            </li>
            ...
            <li className='my-2'>
              <Link href='/apartment' className='text-base'>
                Residential
              </Link>
            </li>
            <li className='my-2'>
            ...
            <li className='my-2'>
              <Link href='/iot/industry' className='text-base'>
                Industrials
              </Link>
            </li>
      ...
      <div className='my-4 md:flex items-center justify-between'>
        ...
        <div className='md:flex gap-5 text-center items-center'>
          ...
          <a className='inline-block mr-3 md:mr-0' href='#'>
            <img
