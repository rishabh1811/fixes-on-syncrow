...
function Form(props) {
  ...
  return (
    ...
    >
      <span className="font-bold desktop:text-2xl laptop:text-xl absolute desktop:top-8 laptop:top-6 left-1">
        {title}
      </span>
      ...
      >
        ...
        <br />
        <br />
        <button className="bg-default text-white desktop:w-52 laptop:w-40 desktop:h-12 laptop:h-9 rounded-lg" type="submit">
          Contact us now!
        </button>
      </form>
    </div >
